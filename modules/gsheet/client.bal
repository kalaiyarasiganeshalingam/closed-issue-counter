...
public client class Client {
    ...
    remote isolated function addSheet(string spreadsheetId, string sheetName) returns string|error {
        ...
        json jsonaddSheet = check replies[0].addSheet;
        json title = check jsonaddSheet.properties.title;
        return title.toString();
    }

    remote isolated function addData(string spreadsheetId, string sheetName,
    ...
    remote isolated function getData(string spreadsheetId, string sheetName,
